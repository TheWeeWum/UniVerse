...
public class ProfileSetup {
    ...
    public static ProfileController setup(UserProfileServlet userProfileServlet) {
        ...
        String userPath = "C:\\Users\\missi\\Y2 - 2023-24\\CSC207\\universe\\external-data\\UserDataBase.json";
        FileUserDataAccessObject userDAO = new FileUserDataAccessObject();
        BuildingFactory buildingFactory = new BuildingFactory();
        EventFactory eventFactory = new EventFactory();
        String buildingPath = "C:\\Users\\missi\\Y2 - 2023-24\\CSC207\\universe\\external-data\\buildings.json";
